...
/obj/structure/outfit_wardrobe
	...
	desc = "Peek in and select one of several snazzy outfits. Narnia not included, sadly."
	...
	var/list/selectable_outfits_to_amount = list(
		...
		/datum/outfit/changeling_space = 2,
		)
...
/obj/structure/outfit_wardrobe/adventuring
	...
	selectable_outfits_to_amount = list(
		...
		/datum/outfit/medieval/ranger = 1,
...
/obj/structure/outfit_wardrobe/adventuring/honk
	...
	color = COLOR_YELLOW
	// Keeps the same wardrobe ID. You can't pick from either questing loadout after using either.
